...
*   **Transitory Regimes & Anchored Expectations:** India ($\beta = -1.11$) and China ($\beta = -1.12$) demonstrate robust headline-to-core reversion, signaling that headline inflation shocks are transitory. In India, this is heavily driven by the adoption of the Flexible Inflation Targeting (FIT) regime by the RBI in 2015, which successfully curtailed the spillover of high food inflation expectations into core metrics. In China, state-administered pricing mechanisms and effective food reserves anchor expectations during external shocks.
*   **Significant Second-Round Propagation:** Russia ($\delta = -1.25$) and Brazil ($\delta = -1.12$) display severe second-round propagation where core inflation actively reverts to headline spikes due to systemic vulnerabilities as large commodity exporters, institutional credibility gaps, and historical wage/price indexation mechanisms. South Africa ($\delta = -0.74$) serves as an intermediate case, maintaining lower inflation persistence due to a more credible domestic monetary framework.
*   **Challenging the Demand-Pull Paradigm:** The OLS results challenge the traditional demand-pull framework. In China, Brazil, and Russia, government expenditure and gross fixed capital formation are negatively associated with headline inflation, operating as functional supply-side tools that expand infrastructure capacity, eliminate bottlenecks, and reduce frictional costs rather than acting as mere demand stimuli.
